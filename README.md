...
<!-- evidence:course -->
Every module the course covered is in here somewhere. Each row links to the code that does it and to the test that covers it, pinned to commit `098cf14`. [docs/COURSE_MAPPING.md](docs/COURSE_MAPPING.md) says more about each.
...
From [`app/agents/schemas.py`](https://github.com/rahulramachandran-labs/reconmind/blob/098cf140f01512cfed7e6020154acc459270acaf/app/agents/schemas.py#L53-L88):
